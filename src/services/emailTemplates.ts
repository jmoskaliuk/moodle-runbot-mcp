...
function baseLayout(opts: {
  title:  string;
  preheader?: string;   // Vorschautext (im Client-Preview sichtbar, in der Mail versteckt)
  content: string;      // Bereits gerenderter HTML-Inhalt
  ctaBg?: string;       // Für Mail-spezifische Accent-Variante (z.B. grün für "Ready")
}): string {
...
function button(href: string, label: string, bg: string = COLORS.accent): string {
