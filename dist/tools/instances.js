...
function instanceUrl(instance) {
    if (BASE_DOMAIN)
        return `http://${instance.id}.${BASE_DOMAIN}`;
...
// ── Tool: instance_start ──────────────────────────────────────────────────────
export function registerInstanceStart(server) {
    server.registerTool("instance_start", {
...
// ── Tool: instance_stop ───────────────────────────────────────────────────────
export function registerInstanceStop(server) {
    server.registerTool("instance_stop", {
...
export function registerInstanceStatus(server) {
...
// ── Tool: instance_list ───────────────────────────────────────────────────────
export function registerInstanceList(server) {
    server.registerTool("instance_list", {
...
// ── Tool: instance_logs ───────────────────────────────────────────────────────
export function registerInstanceLogs(server) {
    server.registerTool("instance_logs", {
...
export function registerInstanceRunTests(server) {
    server.registerTool("instance_run_tests", {
...
Returns:
  { instanceId, newExpiresAt, extensionsUsed, extensionsRemaining }`,
        ...
        const extensions = instance.extensions ?? 0;
        ...
        instance.extensions = extensions + 1;
...
export function registerInstanceTimeRemaining(server) {
    server.registerTool("instance_time_remaining", {
